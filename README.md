...
[-] Offensive security — 70+ documented lab engagements. Active
    Directory end to end: AS-REP roasting, Kerberoasting, DCSync,
    ADCS and ACL abuse, BloodHound path reasoning, spraying under
    lockout constraints. Web exploitation, Linux and Windows privesc,
    exploit dev and reversing fundamentals. The methodology ships as
    tooling: an MCP stack (recon, C2) that lets an AI agent drive the
    kill chain under explicit safety gates.
[-] Darknet & anonymity networks — Tor / I2P / DNM ecosystem research;
    vendor and marketplace profiling, cross-platform identity
    resolution, OPSEC failure analysis — where attribution succeeds
    and where investigations break. Published analyses at
    v0idravl.github.io, signed and timestamped.
[-] Surveillance tradecraft — overt/covert, CCTV, plainclothes;
    rapid behavior-based assessment, never appearance-based;
    non-confrontational interview methodology.
[-] Investigations & evidence discipline — two-source corroboration
    standard; nothing single-source goes in a report. Chain of
    custody kept to documentary standard — every claim traceable
    to a command, a log, or a screenshot.
[-] Host defense & opsec — behavioral anomaly detection: no
    signatures, no network calls; insider-threat-shaped modeling.
[-] Systems — Linux internals, x86 assembly, eBPF, bubblewrap
    sandboxing, kernel hardening.
[-] Data analysis & crypto tracing — on-chain analysis, address
...
- [chr0nix] — the investigative-
  ...
  behind risk-tiered attestation — evidence discipline that survives
  scrutiny.

host defense

- [traxerax-lite] — behavioral
...
[![whoami](https://img.shields.io/badge/whoami-v0idravl.github.io%2Fwhoami-0A3161)](https://v0idravl.github.io/whoami)
[![lab-writeups](https://img.shields.io/badge/lab--writeups-70%2B%20engagements-FFFFFF)](https://v0idravl.github.io/lab-writeups)
[![p0rtix](https://img.shields.io/badge/p0rtix-recon-B31942)](https://github.com/v0idravl/p0rtix)
[![hakiki](https://img.shields.io/badge/hakiki-field%20reference-FFFFFF)](https://v0idravl.github.io/hakiki)
[![chr0nix](https://img.shields.io/badge/chr0nix-investigative--doc%20suite-0A3161)](https://github.com/v0idravl/chr0nix)

[![email](https://img.shields.io/badge/email-pgp%20preferred-B31942)](mailto:v0id.ravl@mailbox.org)
[![pgp](https://img.shields.io/badge/pgp-pubkey.asc-FFFFFF)](https://v0idravl.github.io/whoami/pubkey.asc)
[![canary](https://img.shields.io/badge/canary-monthly-0A3161)](https://v0idravl.github.io/whoami/canary.txt.asc)
[![usa](https://img.shields.io/badge/%F0%9F%87%BA%F0%9F%87%B8-0A3161)](https://v0idravl.github.io)
