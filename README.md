...
║    ╚═══╝   ╚═════╝ ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝  ╚═══╝  ╚══════╝              ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  internal pentest track  ::  active directory  ::  enterprise networks       ║
╚══════════════════════════════════════════════════════════════════════════════╝
...
┌─[ links ]────────────────────────────────────────────────────────────────────┐
│ github    : https://github.com/v0idravl                                      │
│ htb       : https://app.hackthebox.com/profile/v0idravl                      │
│ x         : https://x.com/v0idravl                                           │
└──────────────────────────────────────────────────────────────────────────────┘

┌─[ status ]───────────────────────────────────────────────────────────────────┐
│ no client, production, or proprietary offensive material is published here.  │
│ public work is sanitized and limited to lab, personal infrastructure, or     │
